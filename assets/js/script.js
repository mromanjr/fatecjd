...
$(window).load(function() {
	...
	$(function() {
		var $mainNav    = $('#main_menu').children('ul'),
			...
			optionsList = '<option value="" selected style="display:none;">Navega&ccedil;&atilde;o</option>';
		...
		$mainNav.find('li').each(function() {
			...
			optionsList += '<option value="' + $anchor.attr('href') + '">' + indent + ' ' + $anchor.attr("valor") + '</option>';
		}).end()
