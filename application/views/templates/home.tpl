...
<div id="blocoDestaques">
	...
	<ul>
		...
		{$url = str_replace(" ","-",strtolower($v['titulo']))}
		
		<li>
			
			<a href="{base_url()|cat: "noticias/"|cat: $url}" title="{$v['descr']}">
				{html_image file=base_url()|cat: "uploads/destaques/"|cat: $v['imgdestaque'] class="ie6"} 
			</a>
			<div class="fundo"><!--  --></div>
